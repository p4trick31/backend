...
from .models import Application, RenewalForm, RequestForm, SystemReport, Profile, DailyReport
...
class SystemReportSerializer(serializers.ModelSerializer):
    class Meta:
        model = SystemReport
        fields = ['id', 'reason', 'message', 'created_at', 'username', 'is_respond', 'position' ]
...
class DailyReportSerializer(serializers.ModelSerializer):
    class Meta:
        model = DailyReport
        fields = ['id', 'date', 'text', 'generated_at', 'generated_by']
